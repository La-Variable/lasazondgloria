/*
--- Lógica de Aplicación (PWA) - La Sazón de Gloria ---
--- VERSIÓN: 1.3 (100% Funcional con Firebase v9+) ---
--- Fundamento: Acción Validada 21:38 (10/11/25) ---
*/

// =====================================================================
// INICIALIZACIÓN Y CONFIGURACIÓN DE FIREBASE (v9+ ESM)
// =====================================================================
...
// FUNDAMENTO: Configuración proporcionada por el usuario (10/11/25).
...
window.app = {
    ...
    profile: {
        async load() {
            ...
            try {
                // Leer las reglas de FASE 1 (Paso 1.4)
                const q = query(
                    ordersCol,
        ...
        getStatusColor(status) {
            const colors = { "ENTREGADO": "bg-green-100 text-green-800", "EN_CAMINO": "bg-blue-100 text-blue-800", "EN_PREPARACION": "bg-yellow-100 text-yellow-800", "RECIBIDO": "bg-yellow-100 text-yellow-800", "CANCELADO": "bg-red-100 text-red-800" };
